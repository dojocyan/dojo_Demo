...
dojochain.Error = function ()
{
    this.message = 'Internal error';
    this.stack = this.message + '\n' + (new Error()).stack;
};
dojochain.Error.prototype = Object.create(Error.prototype);
dojochain.Error.prototype.name = 'bitcore.Error';

traverseRoot(dojochain.Error, _xerrorData);
...
errors = dojochain.Error;
errors.extend = function (spec)
{
    return traverseNode(dojochain.Error, spec);
};
// errors end-------------------------------------------------------------------------------
...
dojochain.BufferUtil = BufferUtil;
// util/buffer end--------------------------------------------------------------------------
...
dojochain.elliptic_utils = elliptic_utils;
// elliptic/utils end----------------------------------------------------------------------
...
dojochain.Base58Check = Base58Check;
...
dojochain.BufferReader = BufferReader;
...
dojochain.BufferWriter = BufferWriter;
...
dojochain.PrivateKey = PrivateKey;
// privatekey end----------------------------------------------------------------------
...
dojochain.HDPrivateKey = HDPrivateKey;
// hdprivatekey end----------------------------------------------------------------------
...
dojochain.HDPublicKey = HDPublicKey;
// hdpublickey end----------------------------------------------------------------------
...
dojochain.Interpreter = Interpreter;
...
dojochain.UnspentOutput = UnspentOutput;
...
dojochain.TransactionSignature = TransactionSignature;
...
dojochain.MultiSigInput = MultiSigInput;
...
dojochain.MultiSigScriptHashInput = MultiSigScriptHashInput;
...
dojochain.PublicKeyInput = PublicKeyInput;
...
dojochain.PublicKeyHashInput = PublicKeyHashInput;
...
dojochain.ContactInput = ContactInput;
...
dojochain.Transaction = Transaction;
...
dojochain.RpcClient = RpcClient;
dojochain.initializeRpc = initializeRpc;
dojochain.sendRpcCommand = sendRpcCommand;
// RPC function end---------------------------------------------------------------------------------
