...
Returns a new DojoChain address for receiving payments.  
...
Result:  
"address"    (string) The new Dojochain address  
  
Examples:  
> Dojochain-cli getnewaddress   
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "getnewaddress", "params": [] }' -H 'content-type: text/plain;' http://127.0.0.1:8332/  
  
## getrawchangeaddress ##  
  
Returns a new DojoChain address, for receiving change.  
...
Examples:  
> Dojochain-cli getrawchangeaddress   
...
> Dojochain-cli getreceivedbyaccount ""  
  
Amount received at the tabby account including unconfirmed amounts with zero confirmations  
> Dojochain-cli getreceivedbyaccount "tabby" 0  
  
The amount with at least 6 confirmations  
> Dojochain-cli getreceivedbyaccount "tabby" 6  
...
Arguments:  
1. "address"         (string, required) The Dojochain address for transactions.  
2. minconf             (numeric, optional, default=1) Only include transactions confirmed at least this many times.  
...
> Dojochain-cli getreceivedbyaddress "1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX"  
  
The amount including unconfirmed transactions, zero confirmations  
> Dojochain-cli getreceivedbyaddress "1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX" 0  
  
The amount with at least 6 confirmations  
> Dojochain-cli getreceivedbyaddress "1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX" 6  
...
{  
  ...
  "details" : [  
    {  
      ...
      "address" : "address",          (string) The Dojochain address involved in the transaction  
...
Examples:  
> Dojochain-cli gettransaction "1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d"  
> Dojochain-cli gettransaction "1075db55d416d3ca199f55b6084e2115b9345e16c5cf302fc80e9d5fbf5d48d" true  
...
> Dojochain-cli importaddress "myscript"  
  
Import using a label without rescan  
> Dojochain-cli importaddress "myscript" "testing" false  
...
Examples:  
> Dojochain-cli importmulti '[{ "scriptPubKey": { "address": "<my address>" }, "timestamp":1455191478 }, { "scriptPubKey": { "address": "<my 2nd address>" }, "label": "example 2", "timestamp": 1455191480 }]'  
> Dojochain-cli importmulti '[{ "scriptPubKey": { "address": "<my address>" }, "timestamp":1455191478 }]' '{ "rescan": false}'  
...
> Dojochain-cli importprivkey "mykey" "testing" false  
  
Import using default blank label and without rescan  
> Dojochain-cli importprivkey "mykey" "" false  
...
> Dojochain-cli importpubkey "mypubkey"  
  
Import using a label without rescan  
> Dojochain-cli importpubkey "mypubkey" "testing" false  
...
Import the wallet  
> Dojochain-cli importwallet "test"  
...
> Dojochain-cli listaccounts   
  
List account balances including zero confirmation transactions  
> Dojochain-cli listaccounts 0  
  
List account balances for 6 or more confirmations  
> Dojochain-cli listaccounts 6  
...
[  
  [  
    [  
      "address",            (string) The Dojochain address  
...
Examples:  
> Dojochain-cli listaddressgroupings   
...
> Dojochain-cli lockunspent false "[{\"txid\":\"a08e6907dbbd3d809776dbfc5d82e371b764ed838b5655e72f463568df1aadf0\",\"vout\":1}]"  
  
List the locked transactions  
> Dojochain-cli listlockunspent   
  
Unlock the transaction again  
> Dojochain-cli lockunspent true "[{\"txid\":\"a08e6907dbbd3d809776dbfc5d82e371b764ed838b5655e72f463568df1aadf0\",\"vout\":1}]"  
...
Examples  
> Dojochain-cli listmortgagecoins   
> Dojochain-cli listmortgagecoins 6 9999999 "[\"1PGFqEzfmQch1gKD3ra4k18PNj3tTUUSqg\",\"1LtvqCaApEdUGFkpKMM4MstjcaL4dKg8SP\"]"  
...
> Dojochain-cli listmortgagecoins 6 9999999 '[]' true '{ "minimumAmount": 0.005 }'  
...
Examples:  
> Dojochain-cli listreceivedbyaccount   
> Dojochain-cli listreceivedbyaccount 6 true  
...
Examples:  
> Dojochain-cli listreceivedbyaddress   
> Dojochain-cli listreceivedbyaddress 6 true  
...
{  
  "transactions": [  
    ...
    "address":"address",    (string) The Dojochain address of the transaction. Not present for move transactions (category = move).  
...
Examples:  
> Dojochain-cli listsinceblock   
> Dojochain-cli listsinceblock "000000000000000bacf66f7497b7dc45ef753ee9a7d38571037cdb1a57f663ad" 6  
...
[  
  {  
    ...
    "address":"address",    (string) The Dojochain address of the transaction. Not present for   
...
> Dojochain-cli listtransactions   
  
List transactions 100 to 120  
> Dojochain-cli listtransactions "*" 20 100  
...
1. minconf          (numeric, optional, default=1) The minimum confirmations to filter  
2. maxconf          (numeric, optional, default=9999999) The maximum confirmations to filter  
3. "addresses"      (string) A json array of Dojochain addresses to filter  
    [  
      "address"     (string) Dojochain address  
      ,...  
    ]  
...
[                   (array of json object)  
  {  
    "txid" : "txid",          (string) the transaction id   
    "vout" : n,               (numeric) the vout value  
    "address" : "address",    (string) the Dojochain address  
    "account" : "account",    (string) DEPRECATED. The associated account, or "" for the default account  
    "scriptPubKey" : "key",   (string) the script key  
    "amount" : x.xxx,         (numeric) the transaction output amount in MGC  
    "confirmations" : n,      (numeric) The number of confirmations  
...
Examples  
> Dojochain-cli listunspent   
> Dojochain-cli listunspent 6 9999999 "[\"1PGFqEzfmQch1gKD3ra4k18PNj3tTUUSqg\",\"1LtvqCaApEdUGFkpKMM4MstjcaL4dKg8SP\"]"  
...
> Dojochain-cli listunspent 6 9999999 '[]' true '{ "minimumAmount": 0.005 }'  
...
> Dojochain-cli move "" "tabby" 0.01  
  
Move 0.01 MGC timotei to akiko with a comment and funds have 6 confirmations  
> Dojochain-cli move "timotei" "akiko" 0.01 6 "happy birthday!"  
...
2. "fundaddress"	          (string, required) The Dojochain address of fund to be used  
...
Examples:  
> Dojochain-cli premaketransaction XWzFXFXehphGkSHHebNo3NwR3wMBfTeiPX XWzFXFXehphGkSHHebNo3NwR3wMBfTeiPi XWzFXFXehphGkSHHebNo3NwR3wMBfTeiPj 1 0.0005  
...
2. "fundaddress"                  (string, required) The Dojochain address owns coins to use  
...
Examples:  
> Dojochain-cli prepublishcode code XWzFXFXehphGkSHHebNo3NwR3wMBfTeiPi XWzFXFXehphGkSHHebNo3NwR3wMBfTeiPj 1 0.0005  
...
Examples:  
> Dojochain-cli publishcontract "filepath"  
...
Examples:  
> Dojochain-cli publishcontractcode "code_in_hex_string"  
...
Examples:  
> Dojochain-cli removeprunedfunds "a8d0c0184dde994a09ec054286f1ce581bebf46446a512166eae7628734ea0a5"  
...
DEPRECATED (use sendtoaddress). Sent an amount from an account to a Dojochain address.  
...
1. "fromaccount"       (string, required) The name of the account to send funds from. May be the default account using "".  
                       ...
                       the spend.  
2. "toaddress"         (string, required) The Dojochain address to send funds to.  
...
> Dojochain-cli sendfrom "" "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.01  
  
Send 0.01 from the tabby account to the given address, funds must have at least 6 confirmations  
> Dojochain-cli sendfrom "tabby" "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.01 6 "donation" "seans outpost"  
...
2. "amounts"             (string, required) A json object with addresses and amounts  
    {  
      "address":amount   (numeric or string) The Dojochain address is the key, the numeric amount (can be string) in MGC is the value  
      ,...  
    }  
...
> Dojochain-cli sendmany "" "{\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\":0.01,\"1353tsE8YMTA4EuV7dgUXGjNFf9KpVvKHz\":0.02}"  
  
Send two amounts to two different addresses setting the confirmation and comment:  
> Dojochain-cli sendmany "" "{\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\":0.01,\"1353tsE8YMTA4EuV7dgUXGjNFf9KpVvKHz\":0.02}" 6 "testing"  
  
Send two amounts to two different addresses, subtract fee from amount:  
> Dojochain-cli sendmany "" "{\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\":0.01,\"1353tsE8YMTA4EuV7dgUXGjNFf9KpVvKHz\":0.02}" 1 "" "[\"1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX\",\"1353tsE8YMTA4EuV7dgUXGjNFf9KpVvKHz\"]"  
...
Arguments:  
1. "address"            (string, required) The Dojochain address to send to.  
...
Examples:  
> Dojochain-cli sendtoaddress "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.1  
> Dojochain-cli sendtoaddress "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.1 "donation" "seans outpost"  
> Dojochain-cli sendtoaddress "1M72Sfpbz1BPpXFHz9m3CdqATR44Jvaydd" 0.1 "" "" true  
...
Arguments:  
1. "address"         (string, required) The Dojochain address to be associated with an account.  
2. "account"         (string, required) The account to assign the address to.  
  
Examples:  
> Dojochain-cli setaccount "1D1ZrZNe3JUo7ZycKEYQQiQAWd9y54F4XX" "tabby"  
...
Examples:  
> Dojochain-cli settxfee 0.00001  
...
Arguments:  
1. "address"         (string, required) The Dojochain address to use for the private key.  
2. "message"         (string, required) The message to create a signature of.  
