...
This document provides guidelines for internationalization of the DojoChain Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to DojoChain network</source>
        <translation>
            <numerusform>%n active connection to DojoChain network</numerusform>
            <numerusform>%n active connections to DojoChain network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `Dojochain_en.ts` remains unchanged.
